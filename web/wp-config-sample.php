...
define('DB_NAME', 'MKT_database_name_here' );
define('DB_USER', 'MKT-outreach' );
define('DB_PASSWORD', 'super ultra tree farm' );
...
/* Absolute Path to Wordpress Directory -- DO NOT EDIT PASS HERE */
if ( !defined('ABSPATH') )
